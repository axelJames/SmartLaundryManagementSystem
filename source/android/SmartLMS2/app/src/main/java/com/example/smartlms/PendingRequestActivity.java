...
public class PendingRequestActivity extends AppCompatActivity {
    ...
    void fillPendingRequest(){

        Configs app = (Configs)getApplicationContext();
        String SERVER_IP =  app.getPrivData();
        final String AUTH_URL = SERVER_IP + "washman/pendingrequests/";
...
//        final String requestBody = AESEnc.encrypt(data);
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST, AUTH_URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    Toast toast = Toast.makeText(PendingRequestActivity.this,
                            auth_response,
                            Toast.LENGTH_SHORT);
                        ...
                        if (status==0){
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    Intent i = new Intent(PendingRequestActivity.this, FetchDetailsActivity.class);
                                    Integer re_id = dataModel.getId();
                                    i.putExtra("REQ_ID", re_id);
                                    PendingRequestActivity.this.startActivity(i);

                                }
                            });
                        }
                        else {
                            Toast failed_toast = Toast.makeText(PendingRequestActivity.this,
                                    "Request Failed",
                                    Toast.LENGTH_LONG);
